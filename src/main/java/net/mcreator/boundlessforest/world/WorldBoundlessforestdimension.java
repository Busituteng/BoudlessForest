...
package net.mcreator.boundlessforest.world;
...
import net.mcreator.boundlessforest.item.ItemBoundlessforestdimension;
...
public class WorldBoundlessforestdimension extends ElementsBoundlessForest.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("boundlessforest:boundlessforestdimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldBoundlessforestdimension(ElementsBoundlessForest instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new ItemBoundlessforestdimension().setUnlocalizedName("boundlessforestdimension").setRegistryName("boundlessforestdimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension boundlessforestdimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("boundlessforestdimension", "_boundlessforestdimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemBoundlessforestdimension.block, 0,
				new ModelResourceLocation("boundlessforest:boundlessforestdimension", "inventory"));
	}
	public static class WorldProviderMod extends WorldProvider {
		...
		public net.minecraft.client.audio.MusicTicker.MusicType getMusicType() {
			return EnumHelperClient.addMusicType("boundlessforest:ambient", (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation(("boundlessforest:ambient"))), 6000, 24000);
		}
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.486274509804, 0.549019607843, 0.003921568627);
		}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? Blocks.LEAVES.getStateFromMeta(3).getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? Blocks.LEAVES.getStateFromMeta(3).getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("boundlessforestdimension_portal");
			setRegistryName("boundlessforestdimension_portal");
			setLightLevel(0.15F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.CLOUD, px, py, pz, vx, vy, vz);
			}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.LEAVES.getStateFromMeta(3).getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.LEAVES.getStateFromMeta(3).getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.LEAVES.getStateFromMeta(3).getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.LEAVES
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("boundlessforest:boundlessforest")),};
